...
INSERT INTO `IMAGENS` VALUES (2,'../produtos/img/1671564734.jpeg',4),(3,'../produtos/img/1072762690.jpg',4),(4,'../produtos/img/833092697.jpg',4),(7,'../produtos/img/128838886.jpg',4),(15,'../produtos/img/1484133873.jpeg',10),(16,'../produtos/img/1398118571.jpg',11),(17,'../produtos/img/2085112169.jpg',12),(18,'../produtos/img/561252868.jpeg',12),(19,'../produtos/img/1821432868.png',14);
...
INSERT INTO `MEDIA_AVALIACOES` VALUES (7,4,2,6,3),(8,11,0,0,0),(9,12,1,4,4),(10,13,0,0,0),(11,14,0,0,0);
...
INSERT INTO `SERVICOS` VALUES (12,'Teste 4',7,'dfsfsd','','10',6,5,'53650-560',10,'Rua Professor Bruno Maia','Vila Rural','Igarassu','PE'),(13,'Servico 2',7,'saddasda',NULL,'20',6,5,'53650-560',10,'Rua Professor Bruno Maia','Vila Rural','Igarassu','PE'),(14,'silvio',7,'fdsdsffdsf',NULL,'312213',9,5,'53415-340',0,'Rua TacaimbÃ³','Artur Lundgren I','Paulista','PE');
...
INSERT INTO `USUARIOS` VALUES (6,'Alessandro JosÃ©','Alessandro','81dc9bdb52d04dc20036dbd8313ed055','alessandrosilva325@gmail.com','81992931694','../img/usuarios/1173345430.png',0),(7,'Fastservice','Alessandro0325','202cb962ac59075b964b07152d234b70','thiagomoura86@live.com','81992931694',NULL,0),(8,'','','d41d8cd98f00b204e9800998ecf8427e','','',NULL,0),(9,'gabriel','gabriel','e10adc3949ba59abbe56e057f20f883e','gabriel@gabriel.com','(99)99999-9999',NULL,0),(10,'DSADSAASD','DSADSADSA','e10adc3949ba59abbe56e057f20f883e','DSADSADAS@SADSA.COM','(99)99999-9999',NULL,0);
...
CREATE TABLE `VISITAS` (
  ...
  `VISI_PESSOA_ID` int(11) NOT NULL,
  `VISI_SRV_ID` int(11) NOT NULL,
  `VISI_DATA` datetime DEFAULT NULL,
  PRIMARY KEY (`VISI_ID`),
  KEY `VISI_USER_ID` (`VISI_USER_ID`),
  KEY `VISI_PESSOA_ID` (`VISI_PESSOA_ID`),
  KEY `VISI_SRV_ID` (`VISI_SRV_ID`),
  CONSTRAINT `VISITAS_ibfk_1` FOREIGN KEY (`VISI_USER_ID`) REFERENCES `USUARIOS` (`USER_ID`),
  CONSTRAINT `VISITAS_ibfk_2` FOREIGN KEY (`VISI_PESSOA_ID`) REFERENCES `USUARIOS` (`USER_ID`),
  CONSTRAINT `VISITAS_ibfk_3` FOREIGN KEY (`VISI_SRV_ID`) REFERENCES `SERVICOS` (`SRV_ID`)
...
INSERT INTO `VISITAS` VALUES (17,6,6,12,'2019-05-12 19:47:00');
...
INSERT INTO `VISUALIZACOES` VALUES (1,6,12),(3,7,12),(4,6,13),(5,9,14);
...
-- Dump completed on 2019-05-13 11:57:40
